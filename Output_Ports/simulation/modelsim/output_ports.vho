...
-- writee	=>  Location: PIN_AB12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \U4~1_combout\ = (\address[7]~input_o\ & (\address[6]~input_o\ & (!\address[4]~input_o\ & \address[5]~input_o\)))
...
\writee~input\ : cycloneiii_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
...
-- Equation(s):
-- \U4~0_combout\ = (!\address[2]~input_o\ & (!\address[1]~input_o\ & (\writee~input_o\ & !\address[3]~input_o\)))
...
-- Equation(s):
-- \U3~0_combout\ = (\U4~1_combout\ & (!\address[0]~input_o\ & \U4~0_combout\))
...
\U4~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \U4~2_combout\ = (\U4~1_combout\ & (\address[0]~input_o\ & \U4~0_combout\))
