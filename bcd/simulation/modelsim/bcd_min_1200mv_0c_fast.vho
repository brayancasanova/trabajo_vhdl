...
-- Equation(s):
-- \Mux6~0_combout\ = (\ID~input_o\ & (!\IA~input_o\ & (\IC~input_o\ $ (\IB~input_o\)))) # (!\ID~input_o\ & (\IA~input_o\ $ (((\IC~input_o\) # (\IB~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0001010101010010",
...
-- Equation(s):
-- \Mux5~0_combout\ = (\IB~input_o\ & ((\IA~input_o\) # ((\ID~input_o\ & \IC~input_o\)))) # (!\IB~input_o\ & (((\ID~input_o\) # (\IC~input_o\))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\ID~input_o\ & (\IA~input_o\)) # (!\ID~input_o\ & ((\IB~input_o\ & (\IA~input_o\)) # (!\IB~input_o\ & ((\IC~input_o\)))))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\IA~input_o\ & ((\ID~input_o\) # ((\IC~input_o\) # (\IB~input_o\)))) # (!\IA~input_o\ & (\IB~input_o\ & (\ID~input_o\ $ (\IC~input_o\))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\IC~input_o\ & (\IA~input_o\)) # (!\IC~input_o\ & ((\ID~input_o\ & ((\IA~input_o\) # (!\IB~input_o\))) # (!\ID~input_o\ & ((\IB~input_o\)))))
